...
class OwnerControllerTest {
    ...
    @Test
    void returnlistOwners() throws Exception {
        given(clinicService.findOwnerByLastName("lastName")).willReturn(Lists.newArrayList(new Owner(), new Owner()));
